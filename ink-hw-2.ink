...
// corrected syntax for declaring global variables
...
* Door one 
    ...
    ~ has_rabbit = "true" 
    // corrected syntax for incrementing value
    ~ checked_doors++
    -> doors
* Door two 
...
=== try_to_leave 
// updated values for the conditional to make story work because there are only 4 doors
...
// added divert to how_do_i_wake_up stitch
-> how_do_i_wake_up
]
...
// made this choice into a sticky choice 
+ "You must choose one of us."
    * * Choose rabbit. 
    ~ chosen_animal = "rabbit"
//    -> how_do_i_wake_up
// changed the divert to you_finally_wake_up_on_your_own
